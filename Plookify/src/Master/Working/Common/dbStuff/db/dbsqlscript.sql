...
CREATE TABLE "SUBSCRIPTION" (
	...
	`DUEDATE`	TEXT NOT NULL DEFAULT 0,
	`PUBLICITY`	INTEGER NOT NULL DEFAULT 0,
	FOREIGN KEY(`USERID`) REFERENCES `ID`
);
INSERT INTO `SUBSCRIPTION` VALUES (5,1,3,'2016-03-10',1);
INSERT INTO `SUBSCRIPTION` VALUES (4,0,0,'0',0);
INSERT INTO `SUBSCRIPTION` VALUES (3,1,3,'2016-02-10',0);
INSERT INTO `SUBSCRIPTION` VALUES (2,0,0,'0',0);
INSERT INTO `SUBSCRIPTION` VALUES (1,0,0,'0',0);
...
INSERT INTO `DEVICE` VALUES (1,'asd','PC','2016-03-01',5);
INSERT INTO `DEVICE` VALUES (2,'pls','PHONE','2016-02-29',5);
INSERT INTO `DEVICE` VALUES (3,'Hamza''s Phone','PHONE','2015-10-10',3);
INSERT INTO `DEVICE` VALUES (4,'bacon3','IPAD','2015-10-12',5);
